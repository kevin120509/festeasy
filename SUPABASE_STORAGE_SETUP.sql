...
DROP POLICY IF EXISTS "Las imagenes son publicas" ON storage.objects;
...
-- Política: Los usuarios solo pueden actualizar sus propios archivos
...
-- Habilitar RLS en las tablas principales (ignorar si ya está habilitado)
ALTER TABLE IF EXISTS public.solicitudes ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.paquetes_proveedor ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.perfil_proveedor ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.perfil_cliente ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.cotizaciones ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.items_carrito ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.carrito ENABLE ROW LEVEL SECURITY;
...
DROP POLICY IF EXISTS "Clientes ven sus solicitudes" ON public.solicitudes;
DROP POLICY IF EXISTS "Proveedores ven solicitudes recibidas" ON public.solicitudes;
DROP POLICY IF EXISTS "Clientes crean solicitudes" ON public.solicitudes;
DROP POLICY IF EXISTS "Proveedores actualizan solicitudes" ON public.solicitudes;
...
-- Eliminar políticas existentes
DROP POLICY IF EXISTS "Paquetes publicados son publicos" ON public.paquetes_proveedor;
DROP POLICY IF EXISTS "Proveedores ven sus paquetes" ON public.paquetes_proveedor;
DROP POLICY IF EXISTS "Proveedores crean paquetes" ON public.paquetes_proveedor;
DROP POLICY IF EXISTS "Proveedores actualizan paquetes" ON public.paquetes_proveedor;
DROP POLICY IF EXISTS "Proveedores eliminan paquetes" ON public.paquetes_proveedor;
...
-- Eliminar políticas existentes
DROP POLICY IF EXISTS "Perfiles proveedores son publicos" ON public.perfil_proveedor;
DROP POLICY IF EXISTS "Proveedores actualizan su perfil" ON public.perfil_proveedor;
DROP POLICY IF EXISTS "Clientes ven su perfil" ON public.perfil_cliente;
DROP POLICY IF EXISTS "Clientes actualizan su perfil" ON public.perfil_cliente;
...
-- Eliminar políticas existentes
DROP POLICY IF EXISTS "Proveedores crean cotizaciones" ON public.cotizaciones;
DROP POLICY IF EXISTS "Ver cotizaciones propias" ON public.cotizaciones;
...
-- Eliminar políticas existentes
DROP POLICY IF EXISTS "Clientes gestionan carrito" ON public.carrito;
DROP POLICY IF EXISTS "Clientes gestionan items carrito" ON public.items_carrito;
...
-- ============================================
ALTER TABLE IF EXISTS public.categorias_servicio ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Categorias son publicas" ON public.categorias_servicio;
